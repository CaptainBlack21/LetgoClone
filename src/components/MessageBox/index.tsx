...
import { View, ScrollView, TextInput, Text, Dimensions } from 'react-native'
...
function index() {
    ...
    const [message, setMessage] = useState<string[]>(["Hala satılık mı?", "Fiyatta pazalık payı var mı?", "Ne durumda?"])
    return (
