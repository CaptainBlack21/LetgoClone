...
import { View, ScrollView, TextInput, Text, Dimensions, KeyboardAvoidingView } from 'react-native'
...
function MessageContainer() {
    ...
    const [message, setMessage] = useState<string[]>(["Hala satılık mı?", "Fiyatta pazarlık payı var mı?", "Ne durumda?"])
    return (
        <View style={{ position: "absolute", bottom: 0, width: "100%", height: height * 0.18, shadowColor: "gray", shadowOpacity: 0.3, backgroundColor: "white" }}>
            <View>
